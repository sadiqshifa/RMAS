...
| Reg B — AI/vendor accountability (CFPB Circulars 2022-03, 2023-03) | Confirm AI vendors used in credit decisioning can produce fully compliant adverse action notices | Manual — vendor due diligence, contractual review | N/A as a control to automate — this is actually the **regulatory justification for this project's own Layer 4 governance work**, not something Layer 3 automates away |
