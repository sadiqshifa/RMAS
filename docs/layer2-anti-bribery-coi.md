...
| Regulation O (12 CFR Part 215) | Approval routing for extensions of credit/other benefits to bank insiders | Tool-assisted — most core banking/loan origination systems already flag insider status, but exception routing is often manual | **Medium — deterministic for the flag, human for the decision.** Automating "is this person flagged as an insider" is straightforward; the credit decision itself stays human |
